$(function () {
    ...
    if ($("#status_filter").val() == "ATIVO") {
        ...
        if ($("#organ").val() == "4") {
            ...
            $("#until_rest_portion").prop("disabled", true); 
    ...
    $("#organ").change(function () { 
        ...
        if ($(this).val() == "4") { 
            ...
            $("#dont_loan_aero").hide();
            $("#dont_loan_siape").show();
            $("#rest_portion").prop("disabled", false);
            $("#until_rest_portion").prop("disabled", false);
            ...
            if ($(this).val() == "2" || $(this).val() == "3") {
                ...
                $("#dont_loan_siape").hide();
                $("#until_rest_portion").prop("disabled", true);
                $("#rest_portion").prop("disabled", true); 
                $("#rest_portion").val("");
                $("#until_rest_portion").val("");
            }
        }
    ...
    $("#btn_create").click(function () {
        if($("#organ").val()=="1"){
            if (confirm("Prezados, \n \n O mailing do exército está sem o prazo de término do empréstimo, mas os descontos estão atualizados.") == true) {
                return true;
            } else {
                return false;
            }
