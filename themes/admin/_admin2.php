    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-blue elevation-">
            ...
            <a href="<?= $router->route("dash.dash"); ?>" class="brand-link">
                <img src="<?= url("/shared/images/logo3.png") ?>" width="200" alt="Logo">
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <?php endif;?>
                        <li class="nav-item">
                            <a href="https://api.whatsapp.com/send?phone=5521968243621&text=Ol%C3%A1%2C%20preciso%20de%20ajuda%20com%20Sistema%20Cred" target="blank" class="nav-link">
